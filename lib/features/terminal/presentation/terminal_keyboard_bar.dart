...
class TerminalKeyboardBar extends StatelessWidget {
  ...
  void _toggleHerdrScrollMode() {
    ...
    _triggerHerdrAction(_HerdrAction.editScrollback);
  }
...
enum _HerdrAction {
  ...
  paneLeft('Pane left', Icons.keyboard_arrow_left_rounded, text: 'h'),
  paneRight('Pane right', Icons.keyboard_arrow_right_rounded, text: 'l'),
  paneUp('Pane up', Icons.keyboard_arrow_up_rounded, text: 'k'),
  paneDown('Pane down', Icons.keyboard_arrow_down_rounded, text: 'j'),
  ...
  const _HerdrAction(this.label, this.icon, {required this.text});
